                ...
                <div class="card bg-default shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-4">
                                <h3 class="mb-0">{{ __('Liste Des Encadrants') }}</h3>
                            </div>
                            <div class="col-8 text-right">
                                <a href="{{ route('encadrant.create') }}" class="btn btn-sm btn-default">{{ __('Ajouter encadrant') }}</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td class="text-right">
                                          <div>
                                                    <form action="{{ route('encadrant.destroy', $encadrant->id) }}" method="post">
                                                        ...
                                                        <a class="btn btn-sm btn-default" href="{{ route('encadrant.edit', $encadrant) }}">{{ __('Mofifier') }}</a>
                                                        <button type="button" class="btn btn-sm btn-default" onclick="confirm('{{ __("Êtes-vous sûr de vouloir supprimer ce encadrant?") }}') ? this.parentElement.submit() : ''">
                                                            Supprimer
                                                        </button>
                                                    </form>
                                                </div>
