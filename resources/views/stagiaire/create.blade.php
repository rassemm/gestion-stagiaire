                ...
                <div class="card bg-default shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Ajouter stagiaire') }}</h3>
                            </div>
                            ...
                            <div class="pl-lg-4">
                              <div class="col-xl-12 row">
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('universite') ? ' has-danger' : '' }}">
                                       ...
                                       <select name="universite" id="input-universite" class="form-control border-input{{ $errors->has('universite') ? ' is-invalid' : '' }}" placeholder="{{ __('universite') }}" value="{{ old('universite') }}" required autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('age') ? ' has-danger' : '' }}">
                                       ...
                                       <input type="number" name="age" id="input-age" class="form-control border-input{{ $errors->has('age') ? ' is-invalid' : '' }}" placeholder="{{ __('age') }}" value="{{ old('age') }}" required autofocus>
                                         @if ($errors->has('age'))
                                           <span class="invalid-feedback" role="alert">
