        ...
        <div class="row">
            <div class="col">
                <div class="card bg-default shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('stage.update', $stage->id) }}" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                              <div class="col-xl-12 row">
                                    <div class="col-md-12 form-group{{ $errors->has('projet') ? ' has-danger' : '' }}">
                                       ...
                                       <input type="text" name="projet" id="input-name" class="form-control border-input{{ $errors->has('projet') ? ' is-invalid' : '' }}" placeholder="{{ __('projet') }}" value="{{ old('projet',$stage->projet) }}" required autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('stagiaire_id') ? ' has-danger' : '' }}">
                                       ...
                                       <select name="stagiaire_id" id="input-stagiaire_id" class="form-control border-input{{ $errors->has('stagiaire_id') ? ' is-invalid' : '' }}" placeholder="{{ __('stagiaire_id') }}" selected="{{ old('stagiaire_id',$stage->stagiaire_id) }}" required autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('encadrant_id') ? ' has-danger' : '' }}">
                                       ...
                                       <select name="encadrant_id" id="input-encadrant_id" class="form-control border-input{{ $errors->has('encadrant_id') ? ' is-invalid' : '' }}" placeholder="{{ __('encadrant_id') }}" selected="{{ old('encadrant_id',$stage->encadrant_id) }}" required autofocus>
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('debut') ? ' has-danger' : '' }}">
                                       ...
                                       <input type="date" name="debut" id="input-debut" class="form-control border-input{{ $errors->has('debut') ? ' is-invalid' : '' }}" placeholder="{{ __('debut') }}" value="{{ old('debut',$stage->debut) }}" required autofocus>
                                         @if ($errors->has('debut'))
                                           <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-6 form-group{{ $errors->has('fin') ? ' has-danger' : '' }}">
                                       ...
                                       <input type="date" name="fin" id="input-fin" class="form-control border-input{{ $errors->has('fin') ? ' is-invalid' : '' }}" placeholder="{{ __('fin') }}" value="{{ old('fin',$stage->fin) }}" required autofocus>
                                         @if ($errors->has('fin'))
                                           <span class="invalid-feedback" role="alert">
